  ...
  return (
    <div className='mt-20'>
      <div className='text-center'>
        <Logo className='w-36 mx-auto mb-2' href={null} />
      ...
      <div className='text-center flex flex-col sm:flex-row items-center justify-between border-t border-gray-400 mx-[5%] sm:mx-[10%] mt-12 py-6 gap-6'>
        <p className='text-sm sm:text-base order-last sm:order-first'>© Andrew Osenwe Benyeogor.</p>
        ...
        <div className='flex flex-col items-center gap-6 justify-center w-full sm:w-auto'>
          ...
          <div className='flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full sm:w-auto'>
            ...
            <Link 
              ...
              className='group relative inline-flex items-center justify-center gap-2 px-6 py-3 sm:px-4 sm:py-2 bg-gradient-to-r from-green-500 to-teal-600 text-white font-medium rounded-lg hover:from-green-600 hover:to-teal-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl w-full sm:w-auto max-w-xs sm:max-w-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white'
            >
              {/* Resources Icon */}
              <svg 
                xmlns="http://www.w3.org/2000/svg" 
            ...
            <div className='flex items-center gap-6 sm:gap-6'>
              {/*<Link 
                href="/#work" 
                className='relative group hover:text-blue-600 transition-all duration-200 font-medium text-base sm:text-sm rounded focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500'
              >
            ...
            <ul className='grid grid-cols-2 sm:flex gap-3 sm:gap-4 justify-center items-center max-w-sm sm:max-w-none mx-auto'>
              <li className='w-full sm:w-auto'>
                <a  
                  ...
                  className='group relative inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-800 hover:text-white transition-all duration-300 transform hover:scale-105 w-full sm:w-auto text-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500'
                >
              ...
              <li className='w-full sm:w-auto'>
                <a  
                  ...
                  className='group relative inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg hover:bg-blue-600 hover:text-white transition-all duration-300 transform hover:scale-105 w-full sm:w-auto text-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500'
                >
                  <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li className='w-full sm:w-auto'>
                <a  
                  ...
                  className='group relative inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg hover:bg-orange-500 hover:text-white transition-all duration-300 transform hover:scale-105 w-full sm:w-auto text-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500'
                >
                  <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li className='w-full sm:w-auto'>
                <a  
                  ...
                  className='group relative inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg hover:bg-sky-600 hover:text-white transition-all duration-300 transform hover:scale-105 w-full sm:w-auto text-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500'
                >
                  <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li className='w-full sm:w-auto'>
                <a  
                  ...
                  className='group relative inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg hover:bg-red-500 hover:text-white transition-all duration-300 transform hover:scale-105 w-full sm:w-auto text-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500'
                >
                  <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li className='w-full sm:w-auto'>
                <a  
                  ...
                  className='group relative inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg hover:bg-teal-600 hover:text-white transition-all duration-300 transform hover:scale-105 w-full sm:w-auto text-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500'
                >
                  <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M5.242 13.769L0 9.5 12 0l12 9.5-5.242 4.269C17.548 11.249 14.978 9.5 12 9.5c-2.977 0-5.548 1.748-6.758 4.269zM12 10a7 7 0 1 0 0 14 7 7 0 0 0 0-14z"/>
                  </svg>
